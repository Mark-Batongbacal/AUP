...
public sealed class AdminTricyclePointSubmissionServiceTests
{
    ...
    [Fact]
    public async Task UpdateReviewAsync_PendingSubmission_UpdatesCoordinatesAndAdminFields()
    {
        ...
        Assert.Equal(15.222222m, submission.Latitude);
        Assert.Equal(120.555555m, submission.Longitude);
