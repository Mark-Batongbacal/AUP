...
public sealed class FacebookOptions
{
    ...
    public const string LimitedOidcIssuer = "https://limited.facebook.com";
    public const string LimitedOidcJwksUri = "https://limited.facebook.com/.well-known/oauth/openid/jwks/";
